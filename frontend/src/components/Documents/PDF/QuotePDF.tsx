// frontend/src/components/Documents/PDF/QuotePDF.tsx
...
const QuotePDF: React.FC<QuotePDFProps> = ({ data, settings }) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.amountInWordsSection}>
          <Text style={styles.amountInWordsText}>
            Arrêté le présent devis à la somme de : {montantEnLettres(data.total)}
          </Text>
        </View>
        ...
        {/* Validité */}
        <View style={styles.section}>
          <Text>Devis valable jusqu'au {data.valid_until || new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString('fr-FR')}</Text>
        </View>
        ...
        <View style={styles.signatureSection}>
          <View style={styles.signatureBox}>
            ...
            <Text style={{ marginTop: 20 }}>Signature du client</Text>
          </View>
          <View style={styles.signatureBox}>
